...
CREATE TABLE users (
    ...
    role ENUM('admin', 'coordinator', 'faculty', 'internal_accreditor', 'external_accreditor') NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- ==========================================
-- It stores the scores and remarks from Accreditors.

CREATE TABLE evaluations (
    id INT AUTO_INCREMENT PRIMARY KEY,
    
    -- Who is being evaluated? (e.g., BSIT 2025 Cycle)
    cycle_id INT NOT NULL,
    
    -- Which Area is being graded? (e.g., Area 1: VMGO)
    area_id INT NOT NULL,
    
    -- Who is the grader? (Must be an Accreditor)
    ...
    -- The Scores & Feedback
    overall_score DECIMAL(5,2), -- e.g., 4.50
    remarks TEXT,
    recommendation TEXT,
